...
export const DEFAULT_STABLE_PROTOCOL_PARAMS: Record<
  NetworkEnvironment,
  StableProtocolParams
> = {
...
export const DEFAULT_UNSTABLE_PROTOCOL_PARAMS: Record<
  NetworkEnvironment,
...
export const DEFAULT_PROTOCOL_PARAMS: Record<
  NetworkEnvironment,
  ProtocolParameters
> = {
  [NetworkEnvironment.MAINNET]: {
...
export function getCostModelMap(
  costModels: CostModels,
): Record<"PlutusV1" | "PlutusV2", Record<string, number>> {
  return {
    PlutusV1: Object.fromEntries(
      costModels.PlutusV1.map((val, idx) => [
        COST_MODEL_KEYS.PlutusV1[idx],
        val,
      ]),
    ),
    PlutusV2: Object.fromEntries(
      costModels.PlutusV2.map((val, idx) => [
        COST_MODEL_KEYS.PlutusV1[idx],
        val,
      ]),
    ),
