...
export const MarketConfigResponseSchema = Type.Object({
  ...
  long_collateral_market_id: Type.String({ description: "Liqwid market ID for long collateral" }),
  short_collateral_market_id: Type.String({ description: "Liqwid market ID for short collateral" }),
